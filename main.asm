...
diffuse proc
    ...
    ;N, iter, dt, diff, vel0, vel, b value (With b value as the last push)
    ; Outputs - nothing
...
printToConsole proc messageToPrint: dword, consoleOutHnd: dword, bWritten: dword
    push eax
    push ebx
    push ecx
    push edx
    ...
    invoke WriteConsoleA, consoleOutHnd, edx, eax, bWritten, 0 ; writing to console
    popad
...
WndProc PROC hWnd:HWND, uMsg:UINT, wParam:WPARAM, lParam:LPARAM
    ...
    ON_WM_CREATE:
        ...
        invoke printToConsole, offset message, consoleOutHandle, offset bytesWritten ; printing to console the display
